...
# 5. Now we will run the analysis step by step to see whats going on 
...
# 6. So we have the actual steps that we've gone through to get to DE in one place generate the dds object again and use the DESeq() function to perform steps 1-3 in one go
