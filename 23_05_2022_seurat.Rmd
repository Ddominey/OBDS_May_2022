...
```{r}
seurat_object <- CreateSeuratObject(counts = Read10x_data, project = "pmbc5k", assay = "RNA", min.cells = 3, min.features = 200)
...
head(seurat_object[[]][,1]) #Returns a vector
head(seurat_object[["nCount_RNA"]][,1]) #Returns a data frame
```
...
> Answer:
> We kept all features, but discarded 896 cells because of bad Quality (during QC).
